function calcularCrescimento(altura1, taxa1, altura2, taxa2) {
    if(altura1 == altura2){
        if(taxa1 > taxa2){
            return 'A crianca 1 ultrapassará a crianca 2 em 1 ano.'
        } else if (taxa1 < taxa2){
            return 'A crianca 2 ultrapassará a crianca 1 em 1 ano.'
        }else {
        ...
        if (altura1 > altura2){
            if(taxa1 >= taxa2){
                return 'A crianca menor nao ultrapassará a maior.'
            }else {
                return calcularTempo(altura2, taxa2, altura1, taxa1)
            }
        } else{
            if(taxa2 >= taxa1){
                return 'A crianca menor não ultrapassará a maior.'
            }else {
